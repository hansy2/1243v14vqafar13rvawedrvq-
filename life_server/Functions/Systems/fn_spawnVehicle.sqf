...
//[1,"Your vehicle is ready!"] remoteExecCall ["life_fnc_broadcast",_unit]; Original

if((_vInfo select 12) == 1) then {
[1,"Ihr Fahrzeug ist bereit und versichert!"] remoteExecCall ["life_fnc_broadcast",_unit];
}
else {
[1,"Ihr Fahrzeug ist fertig!"] remoteExecCall ["life_fnc_broadcast",_unit];
};
